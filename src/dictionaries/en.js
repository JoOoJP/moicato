const dict = {
  meta: {
    title: "Moikato — Brazilian handmade bio-jewellery",
    description:
      "Handmade Brazilian bio-jewellery — seeds, natural fibres and the rare golden grass of Jalapão. Every piece carries its origin, the communities of the Cerrado and a story from Brazil.",
  },
  header: {
    home: "Moikato — home",
    brandEyebrow1: "Bio-jewellery",
    brandEyebrow2: "of the cerrado",
    nav: {
      colecao: "Collection",
      jornada: "The journey",
    ...
    menu: "Menu",
    menuNav: "Navigation",
    drawerNote: "Golden grass from Jalapão · handmade",
    language: "Language",
    contact: "Get in touch",
  },
  hero: {
    eyebrow: "The gold of the Cerrado · handmade",
    titleBefore: "Nature, made ",
    titleEm: "jewel",
    titleAfter: ".",
    lead: "Handmade bio-jewellery crafted from seeds, natural fibres and the rare golden grass of Jalapão — each piece a living story from Brazil.",
    ctaPrimary: "View collection",
    ctaSecondary: "Discover the golden grass",
    scroll: "scroll",
  },
  values: {
    items: [
  ...
  story: {
    eyebrow: "The story · from field to jewel",
    titleBefore: "From the Cerrado to the ",
    titleEm: "jewel",
    titleAfter: ".",
    lead: "Golden grass is a rare everlasting flower that grows only in Jalapão, in Tocantins. Follow its journey — from the field to the hands that turn it into a jewel.",
    stepLabel: "Step {i} of {total}: {title}",
    scenes: [
      {
        n: "01",
        tag: "Jalapão · TO",
    ...
    makersEyebrow: "Who makes it",
    makersTitle: "Made by Brazilian hands",
    makersP1:
      "Every piece is born in the quilombola communities of Mumbuca, in Mateiros — where the craft of sewing golden grass with buriti fibre is passed down through generations.",
    makersP2:
  ...
  catalog: {
    ...
    waPiece:
      'Hello! I\'m interested in the "{name}" piece ({material}). Is it still available?',
  ...
  footer: {
    ...
    copyright:
      "© {year} Moikato — Brazilian handmade bio-jewellery. Handmade with natural materials.",
    waFooter:
      "Hello! I came from the Moikato website and I'd like to place an order.",
  },
};
